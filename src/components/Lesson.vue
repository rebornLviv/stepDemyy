...
export default {
    ...
    created() {
        ...
        console.log('currrentLessodddn', this.$store.getters.getCurrentLesson);

    },
    mounted() {
        console.log('Mooouuunted')
        console.log('Mooouuunted', this.$store.getters.getLessons[this.$store.getters.getCurrentLesson].rating)
